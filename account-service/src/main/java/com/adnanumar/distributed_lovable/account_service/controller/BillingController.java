...
import com.adnanumar.distributed_lovable.account_service.dto.subscription.*;
        ...
        try {
            ...
            if (deserializer.getObject().isPresent()) {
                ...
                try {
                    ...
                    log.error("Unsafe deserializer failed for event {}, {}", event.getType(), e.getMessage());
                    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Deserializer failed");
                }
            }
