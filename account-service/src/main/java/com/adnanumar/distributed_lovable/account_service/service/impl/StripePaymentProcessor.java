package com.adnanumar.distributed_lovable.account_service.service.impl;

import com.adnanumar.distributed_lovable.account_service.dto.subscription.CheckoutRequest;
import com.adnanumar.distributed_lovable.account_service.dto.subscription.CheckoutResponse;
import com.adnanumar.distributed_lovable.account_service.dto.subscription.PortalResponse;
...
import com.adnanumar.distributed_lovable.account_service.repository.PlanRepository;
import com.adnanumar.distributed_lovable.account_service.repository.UserRepository;
import com.adnanumar.distributed_lovable.account_service.service.PaymentProcessor;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public CheckoutResponse createCheckoutSessionUrl(CheckoutRequest request) {
        ...
        var params = SessionCreateParams.builder()
                .addLineItem(
                        SessionCreateParams.LineItem.builder().setPrice(plan.getStripePriceId())
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        switch (type) {
            ...
            case "customer.subscription.updated" -> handleCustomerSubscriptionUpdated((Subscription) stripeObject);    // when user cancels, upgrade or any updates
