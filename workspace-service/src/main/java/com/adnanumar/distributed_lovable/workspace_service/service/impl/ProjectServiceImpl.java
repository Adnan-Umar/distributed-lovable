...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ProjectResponse createProject(ProjectRequest request) {
        ...
        if (!canCreateNewProject()) {
            throw new BadRequestException("You can't create new a project with current Plan, Upgrade plan now.");
        }
    ...
    @Override
    @PreAuthorize("@security.canViewProject(#projectId)") // Spring Expression Language (SpEL)
    ...
    @Override
    @PreAuthorize("@security.canEditProject(#projectId)") // Spring Expression Language (SpEL)
    public ProjectResponse updateProject(Long projectId, ProjectRequest request) {
        ...
        /// THIS LINE IS NOT MANDATORY BECAUSE OF @Transactional
        project = projectRepository.save(project);
