...
import com.adnanumar.distributed_lovable.workspace_service.entity.ProcessedEvent;
import com.adnanumar.distributed_lovable.workspace_service.repository.ProcessedEventRepository;
...
public class FileStorageConsumer {
    ...
    private void sendResponse(FileStoreRequestEvent requestEvent, boolean success, String error) {
        ...
        kafkaTemplate.send("file-store-responses-event-topic", response);
    }
